 ...
 * @author marcel
 */
public class jDlgMbsProdutoNovo extends javax.swing.JDialog {
     ...
     */
    public jDlgMbsProdutoNovo(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        ...
        jTblProdutos.setModel(mbsProdutoControle);
    ...
    private void initComponents() {
        ...
        jLabel18.setText("Cadastro de Produtos");
        ...
        jLabel19.setText("Cadastro de Produtos");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(jDlgMbsProdutoNovo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                jDlgMbsProdutoNovo dialog = new jDlgMbsProdutoNovo(new javax.swing.JFrame(), true);
