...
public class jDlgMbsCompraPesquisa extends javax.swing.JDialog {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(jDlgMbsCompraPesquisa.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                jDlgMbsCompraPesquisa dialog = new jDlgMbsCompraPesquisa(new javax.swing.JFrame(), true);
