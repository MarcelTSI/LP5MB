 ...
 */
public class jFrmMbsLogin extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Instrumentaliza Compras");
    ...
    private void jBtnAcessarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtnAcessarActionPerformed
        ...
        MbsUsuariosDAO usuarioDAO = new MbsUsuariosDAO();
        
        if (usuarioDAO.buscarLogin(apelido, senha) != null) {
            JOptionPane.showMessageDialog(null, "Usuário logado com sucesso!");

            jFrmMbsPrincipal JFrmPrincipal = new jFrmMbsPrincipal();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(jFrmMbsLogin.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new jFrmMbsLogin().setVisible(true);
            }
        });
    }
