 ...
 * @author USER
 */
public class jDlgMbsConsultaFuncionario extends javax.swing.JDialog {
    private final MbsFuncionarioControle mbsFuncionarioControle;
    private final MbsFuncionarioDAO mbsFuncionarioDAO;
    /**
     * Creates new form jDlgConsultaUsuarios
     */
    public jDlgMbsConsultaFuncionario(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        ...
        jTblTabelaColsulta.setModel(mbsFuncionarioControle);
    }
    ...
    private void jBtnConsultarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtnConsultarActionPerformed
        if (jTxtNome.getText().equals("") && jTxtCpf.getText().equals("")) {
            ...
            if (!jTxtNome.getText().equals("") && !jTxtCpf.getText().equals("")) {
                List lista = mbsFuncionarioDAO.listNomeCpf(jTxtNome.getText(), jTxtCpf.getText());
                mbsFuncionarioControle.setList(lista);
            } else {
                if (!jTxtNome.getText().equals("")) {
                    List lista = mbsFuncionarioDAO.listNome(jTxtNome.getText());
                    mbsFuncionarioControle.setList(lista);
                }
                if (!jTxtCpf.getText().equals("")) {
                    List lista = mbsFuncionarioDAO.listCpf(jTxtCpf.getText());
                    mbsFuncionarioControle.setList(lista);
                }
            }
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(jDlgMbsConsultaFuncionario.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                jDlgMbsConsultaFuncionario dialog = new jDlgMbsConsultaFuncionario(new javax.swing.JFrame(), true);
