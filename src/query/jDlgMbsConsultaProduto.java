 ...
 * @author Marcel
 */
public class jDlgMbsConsultaProduto extends javax.swing.JDialog {
    
    MbsProdutoControle mbsProdutoControle;
    MbsProdutoDAO mbsProdutoDAO;

    /**
     * Creates new form jDlgMbsConsultaProduto
     */
    public jDlgMbsConsultaProduto(java.awt.Frame parent, boolean modal) {
        ...
        jTable1.setModel(mbsProdutoControle);
    ...
    private void initComponents() {
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addComponent(jTxtPreco, javax.swing.GroupLayout.DEFAULT_SIZE, 274, Short.MAX_VALUE)
        ...
        mbsProdutoControle.setList(lista);
            ...
            if(!jTxtNome.getText().equals("") && !jTxtPreco.getText().equals("")){
                double preco = Util.strDouble(jTxtPreco.getText());
                 jTxtPreco.setText(String.valueOf(preco));
                List lista = mbsProdutoDAO.listNomePreco(jTxtNome.getText(), preco);
                mbsProdutoControle.setList(lista);
            }else{
                if(! jTxtNome.getText().equals("")){
        
                List lista = mbsProdutoDAO.listNome(jTxtNome.getText());
                mbsProdutoControle.setList(lista);
                ...
                double preco = Util.strDouble(jTxtPreco.getText());
                jTxtPreco.setText(String.valueOf(preco));
                List lista = mbsProdutoDAO.listPreco(preco);
                mbsProdutoControle.setList(lista);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(jDlgMbsConsultaProduto.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                jDlgMbsConsultaProduto dialog = new jDlgMbsConsultaProduto(new javax.swing.JFrame(), true);
